...
import { OrderInfo, ERC1155AssetData, ERC20AssetData } from '@0x/types';
...
const ordersToUIOrdersWithOrdersInfo = (
    ...
    return orders.map((order, i) => {
        ...
        const makerAssetAddress = (assetDataUtils.decodeAssetDataOrThrow(order.makerAssetData) as ERC20AssetData).tokenAddress;
        ...
        const takerAssetAddress = (assetDataUtils.decodeAssetDataOrThrow(order.takerAssetData) as ERC20AssetData).tokenAddress;
